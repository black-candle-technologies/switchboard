...
import { formatTypeScript } from "../utils/fs.js";
...
${shapeProps}
      ...
      await fs.writeFile(
        ...
        await formatTypeScript(configFile),
        "utf8"
      );
...
${fieldsForUI
  ...
  .join("\n")}
      ...
      await fs.writeFile(
        ...
        await formatTypeScript(listPage),
        "utf8"
      );
      await fs.writeFile(
        path.join(adminDir, "new", "page.tsx"),
        await formatTypeScript(newPage),
        "utf8"
      );
      await fs.writeFile(
        path.join(adminDir, "[id]", "edit", "page.tsx"),
        await formatTypeScript(editPage),
        "utf8"
      );
    ...
    await fs.outputFile(
      ...
      await formatTypeScript(registryText),
      "utf8"
    );
